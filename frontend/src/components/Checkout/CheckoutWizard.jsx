      ...
      {steps.map((step, index) => (
        <React.Fragment key={step}>
          <div className="flex flex-col items-center">
            ...
            <span
              className={`text-sm mt-2 font-medium ${currentStep >= index + 1 ? "text-gray-900" : "text-gray-400"}`}
            >
              {step}
            </span>
          </div>
          {index < steps.length - 1 && (
            <div
              className={`h-1 w-16 md:w-32 mx-2 rounded transition-colors duration-300 ${currentStep > index + 1 ? "bg-green-500" : "bg-gray-200"}`}
            />
          )}
        </React.Fragment>
      ))}
...
const OrderSummaryPanel = ({
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 sticky top-24">
      ...
      <div
        className="p-4 lg:hidden flex justify-between items-center cursor-pointer bg-gray-50 rounded-t-xl"
      ...
      <div className={`${isOpen ? "block" : "hidden"} lg:block p-6`}>
        <h3 className="text-xl font-bold mb-4 hidden lg:block text-gray-800">
          Order Summary
        </h3>
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#f63b60] outline-none transition-shadow"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          <div>
            ...
            >
              ...
              {shippingInfo.country &&
                State.getStatesOfCountry(shippingInfo.country).map((s) => (
        ...
        <div className="flex justify-end pt-6">
          <button
            type="submit"
            className="px-8 py-3 bg-[#f63b60] text-white rounded-lg font-semibold hover:bg-[#d42d4a] transition-colors shadow-md hover:shadow-lg w-full md:w-auto"
          >
            Continue to Review
          </button>
        </div>
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 animate-fade-in">
      ...
      <p className="text-gray-600 mb-6">
        Please review your items and order summary on the right before
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200 flex justify-between items-start">
        <div>
          ...
          <p className="text-sm text-gray-600">
            {shippingInfo.line1} {shippingInfo.line2}
          </p>
          <p className="text-sm text-gray-600">
        ...
        <button
          type="button"
          onClick={onBack}
          className="text-[#f63b60] text-sm font-medium hover:underline"
        >
          Edit
        </button>
      </div>
